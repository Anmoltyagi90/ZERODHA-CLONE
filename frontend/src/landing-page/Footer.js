    ...
    <footer className="bg-gray-50 text-gray-700 py-16 px-6 border-t">
      ...
      <div className="mt-16 text-sm text-gray-600 leading-relaxed max-w-5xl mx-auto border-t pt-8">
        <p>
          ...
          please read all the related documents carefully before investing. The
          content, tools, and information provided on this platform are solely
          for educational and informational purposes. We are not responsible for
          any losses incurred due to the use of this information. Make sure to
          do your own research or consult a certified financial advisor before
          making investment decisions. Past performance is not indicative of
          future results. Use this platform responsibly and invest wisely.
        </p>
      </div>
